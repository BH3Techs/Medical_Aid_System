...
class AddressResourceIT {
    ...
    private static final String DEFAULT_SURBURB = "AAAAAAAAAA";
    private static final String UPDATED_SURBURB = "BBBBBBBBBB";
    ...
    void createAddress() throws Exception {
        ...
        assertThat(testAddress.getSurburb()).isEqualTo(DEFAULT_SURBURB);
    ...
    void getAllAddresses() throws Exception {
        ...
        restAddressMockMvc
            ...
            .andExpect(jsonPath("$.[*].surburb").value(hasItem(DEFAULT_SURBURB)))
    ...
    void getAddress() throws Exception {
        ...
        restAddressMockMvc
            ...
            .andExpect(jsonPath("$.surburb").value(DEFAULT_SURBURB))
    ...
    void putExistingAddress() throws Exception {
        ...
        assertThat(testAddress.getSurburb()).isEqualTo(UPDATED_SURBURB);
    ...
    void partialUpdateAddressWithPatch() throws Exception {
        ...
        partialUpdatedAddress.surburb(UPDATED_SURBURB).province(UPDATED_PROVINCE).city(UPDATED_CITY).country(UPDATED_COUNTRY);
