...
import com.xplug.medical_aid_system.domain.enumeration.OwnerType;
...
class DocumentResourceIT {
    ...
    private static final OwnerType DEFAULT_OWNER_TYPE = OwnerType.SPONSOR_DOCUMENT;
    private static final OwnerType UPDATED_OWNER_TYPE = OwnerType.POLICY_DOCUMENT;

    private static final Instant DEFAULT_DATE_CREATED = Instant.ofEpochMilli(0L);
    private static final Instant UPDATED_DATE_CREATED = Instant.now().truncatedTo(ChronoUnit.MILLIS);

    private static final Boolean DEFAULT_VALIDITY = false;
    private static final Boolean UPDATED_VALIDITY = true;
    ...
    void createDocument() throws Exception {
        ...
        assertThat(testDocument.getFormat()).isEqualTo(DEFAULT_FORMAT);
        assertThat(testDocument.getName()).isEqualTo(DEFAULT_NAME);
        assertThat(testDocument.getOwnerType()).isEqualTo(DEFAULT_OWNER_TYPE);
        assertThat(testDocument.getDateCreated()).isEqualTo(DEFAULT_DATE_CREATED);
        assertThat(testDocument.getValidity()).isEqualTo(DEFAULT_VALIDITY);
    }
    ...
    @Test
    @Transactional
    void checkValidityIsRequired() throws Exception {
        int databaseSizeBeforeTest = documentRepository.findAll().size();
        // set the field null
    ...
    void getAllDocuments() throws Exception {
        ...
        restDocumentMockMvc
            ...
            .andExpect(jsonPath("$.[*].validity").value(hasItem(DEFAULT_VALIDITY.booleanValue())));
    }
    ...
    void getDocument() throws Exception {
        ...
        restDocumentMockMvc
            ...
            .andExpect(jsonPath("$.validity").value(DEFAULT_VALIDITY.booleanValue()));
    }
    ...
    void putExistingDocument() throws Exception {
        ...
        Document testDocument = documentList.get(documentList.size() - 1);
        assertThat(testDocument.getFormat()).isEqualTo(UPDATED_FORMAT);
        assertThat(testDocument.getName()).isEqualTo(UPDATED_NAME);
        assertThat(testDocument.getOwnerType()).isEqualTo(UPDATED_OWNER_TYPE);
        assertThat(testDocument.getDateCreated()).isEqualTo(UPDATED_DATE_CREATED);
        assertThat(testDocument.getValidity()).isEqualTo(UPDATED_VALIDITY);
    }
    ...
    void partialUpdateDocumentWithPatch() throws Exception {
        ...
        partialUpdatedDocument.format(UPDATED_FORMAT).name(UPDATED_NAME);
