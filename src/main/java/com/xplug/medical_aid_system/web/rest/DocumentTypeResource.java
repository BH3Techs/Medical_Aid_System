...
import com.xplug.medical_aid_system.domain.DocumentType;
import com.xplug.medical_aid_system.repository.DocumentTypeRepository;
import com.xplug.medical_aid_system.service.DocumentTypeService;
...
/**
 * REST controller for managing {@link com.xplug.medical_aid_system.domain.DocumentType}.
 */
@RestController
@RequestMapping("/api")
public class DocumentTypeResource {
    ...
    public ResponseEntity<DocumentType> updateDocumentType(
        ...
        DocumentType result = documentTypeService.update(documentType);
        return ResponseEntity
            .ok()
    ...
    public ResponseEntity<List<DocumentType>> getAllDocumentTypes(@org.springdoc.api.annotations.ParameterObject Pageable pageable) {
