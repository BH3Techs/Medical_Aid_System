...
import com.xplug.medical_aid_system.service.CurrencyService;
...
/**
 * REST controller for managing {@link com.xplug.medical_aid_system.domain.Currency}.
 */
@RestController
@RequestMapping("/api")
public class CurrencyResource {
    ...
    public ResponseEntity<List<Currency>> getAllCurrencies(@org.springdoc.api.annotations.ParameterObject Pageable pageable) {
