...
import com.xplug.medical_aid_system.repository.ServiceProviderRepository;
import com.xplug.medical_aid_system.service.ServiceProviderService;
...
/**
 * REST controller for managing {@link com.xplug.medical_aid_system.domain.ServiceProvider}.
 */
@RestController
@RequestMapping("/api")
public class ServiceProviderResource {
    ...
    public ResponseEntity<ServiceProvider> updateServiceProvider(
        ...
        ServiceProvider result = serviceProviderService.update(serviceProvider);
        return ResponseEntity
            .ok()
    ...
    public ResponseEntity<ServiceProvider> partialUpdateServiceProvider(
        @PathVariable(value = "id", required = false) final Long id,
        @NotNull @RequestBody ServiceProvider serviceProvider
    ) throws URISyntaxException {
