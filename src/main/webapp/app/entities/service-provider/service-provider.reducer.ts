...
export const createEntity = createAsyncThunk(
  ...
  async (entity: IServiceProvider, thunkAPI) => {
    return axios.post<IServiceProvider>(apiUrl, cleanEntity(entity));
  },
  { serializeError: serializeAxiosError }
);
...
export const updateEntity = createAsyncThunk(
  ...
  async (entity: IServiceProvider, thunkAPI) => {
    return axios.put<IServiceProvider>(`${apiUrl}/${entity.id}`, cleanEntity(entity));
  },
  { serializeError: serializeAxiosError }
);
...
export const partialUpdateEntity = createAsyncThunk(
  ...
  async (entity: IServiceProvider, thunkAPI) => {
    return axios.patch<IServiceProvider>(`${apiUrl}/${entity.id}`, cleanEntity(entity));
  },
  { serializeError: serializeAxiosError }
);
...
export const deleteEntity = createAsyncThunk(
  ...
  async (id: string | number, thunkAPI) => {
    const requestUrl = `${apiUrl}/${id}`;
    return await axios.delete<IServiceProvider>(requestUrl);
  },
  { serializeError: serializeAxiosError }
);
