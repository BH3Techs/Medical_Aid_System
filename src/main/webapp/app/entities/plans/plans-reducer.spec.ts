...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './plans.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_PLANS_LIST actions', async () => {
    ...
    it('dispatches FETCH_PLANS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_PLANS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_PLANS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_PLANS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_PLANS actions', async () => {
      const expectedActions = [
        {
