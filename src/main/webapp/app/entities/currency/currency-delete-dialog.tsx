...
export const CurrencyDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="medicalAidSystemApp.currency.delete.question">
        <Translate contentKey="medicalAidSystemApp.currency.delete.question" interpolate={{ id: currencyEntity.id }}>
