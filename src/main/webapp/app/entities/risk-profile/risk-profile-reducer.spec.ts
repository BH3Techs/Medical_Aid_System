...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_RISKPROFILE_LIST actions', async () => {
    ...
    it('dispatches FETCH_RISKPROFILE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_RISKPROFILE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_RISKPROFILE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_RISKPROFILE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_RISKPROFILE actions', async () => {
      const expectedActions = [
        {
