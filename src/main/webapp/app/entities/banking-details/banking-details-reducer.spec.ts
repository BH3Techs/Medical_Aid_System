...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_BANKINGDETAILS_LIST actions', async () => {
    ...
    it('dispatches FETCH_BANKINGDETAILS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_BANKINGDETAILS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_BANKINGDETAILS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_BANKINGDETAILS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_BANKINGDETAILS actions', async () => {
      const expectedActions = [
        {
