...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './sponsor-administration.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_SPONSORADMINISTRATION_LIST actions', async () => {
    ...
    it('dispatches FETCH_SPONSORADMINISTRATION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_SPONSORADMINISTRATION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_SPONSORADMINISTRATION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_SPONSORADMINISTRATION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_SPONSORADMINISTRATION actions', async () => {
      const expectedActions = [
        {
