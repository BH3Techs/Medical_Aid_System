...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_NEXTOFKIN_LIST actions', async () => {
    ...
    it('dispatches FETCH_NEXTOFKIN actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_NEXTOFKIN actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_NEXTOFKIN actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_NEXTOFKIN actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_NEXTOFKIN actions', async () => {
      const expectedActions = [
        {
