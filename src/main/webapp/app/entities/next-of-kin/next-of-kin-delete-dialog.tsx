...
export const NextOfKinDeleteDialog = () => {
  ...
  const confirmDelete = () => {
    dispatch(deleteEntity(nextOfKinEntity.id));
  };
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="medicalAidSystemApp.nextOfKin.delete.question">
        <Translate contentKey="medicalAidSystemApp.nextOfKin.delete.question" interpolate={{ id: nextOfKinEntity.id }}>
...
export default NextOfKinDeleteDialog;
