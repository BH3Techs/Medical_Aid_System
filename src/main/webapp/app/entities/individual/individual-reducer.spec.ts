...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_INDIVIDUAL_LIST actions', async () => {
    ...
    it('dispatches FETCH_INDIVIDUAL actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_INDIVIDUAL actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_INDIVIDUAL actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_INDIVIDUAL actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_INDIVIDUAL actions', async () => {
      const expectedActions = [
        {
