...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_TARRIFCLAIM_LIST actions', async () => {
    ...
    it('dispatches FETCH_TARRIFCLAIM actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_TARRIFCLAIM actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_TARRIFCLAIM actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_TARRIFCLAIM actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_TARRIFCLAIM actions', async () => {
      const expectedActions = [
        {
