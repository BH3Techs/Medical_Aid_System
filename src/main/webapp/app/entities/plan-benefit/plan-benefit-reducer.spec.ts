...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_PLANBENEFIT_LIST actions', async () => {
    ...
    it('dispatches FETCH_PLANBENEFIT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_PLANBENEFIT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_PLANBENEFIT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_PLANBENEFIT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_PLANBENEFIT actions', async () => {
      const expectedActions = [
        {
