...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_INVOICELINE_LIST actions', async () => {
    ...
    it('dispatches FETCH_INVOICELINE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_INVOICELINE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_INVOICELINE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_INVOICELINE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_INVOICELINE actions', async () => {
      const expectedActions = [
        {
