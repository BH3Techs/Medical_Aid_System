...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CONTACTDETAILS_LIST actions', async () => {
    ...
    it('dispatches FETCH_CONTACTDETAILS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_CONTACTDETAILS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_CONTACTDETAILS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_CONTACTDETAILS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_CONTACTDETAILS actions', async () => {
      const expectedActions = [
        {
