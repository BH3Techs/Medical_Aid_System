...
import com.medical_aid_system.service.InvoiceLineService;
...
/**
 * REST controller for managing {@link com.medical_aid_system.domain.InvoiceLine}.
 */
@RestController
@RequestMapping("/api")
public class InvoiceLineResource {
    ...
    public ResponseEntity<List<InvoiceLine>> getAllInvoiceLines(@org.springdoc.api.annotations.ParameterObject Pageable pageable) {
