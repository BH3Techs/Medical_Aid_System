...
import com.medical_aid_system.service.WalletService;
...
/**
 * REST controller for managing {@link com.medical_aid_system.domain.Wallet}.
 */
@RestController
@RequestMapping("/api")
public class WalletResource {
     ...
     */
    @GetMapping("/wallets")
    public ResponseEntity<List<Wallet>> getAllWallets(@org.springdoc.api.annotations.ParameterObject Pageable pageable) {
