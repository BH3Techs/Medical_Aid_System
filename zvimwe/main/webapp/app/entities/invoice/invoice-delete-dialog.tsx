...
export const InvoiceDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="medicalAidSystemApp.invoice.delete.question">
        <Translate contentKey="medicalAidSystemApp.invoice.delete.question" interpolate={{ id: invoiceEntity.id }}>
