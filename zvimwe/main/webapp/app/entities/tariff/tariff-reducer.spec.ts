...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './tariff.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_TARIFF_LIST actions', async () => {
    ...
    it('dispatches FETCH_TARIFF actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_TARIFF actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_TARIFF actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_TARIFF actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_TARIFF actions', async () => {
      const expectedActions = [
        {
