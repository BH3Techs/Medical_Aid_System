...
export const DocumentDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="medicalAidSystemApp.document.delete.question">
        <Translate contentKey="medicalAidSystemApp.document.delete.question" interpolate={{ id: documentEntity.id }}>
