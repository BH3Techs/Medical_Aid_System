...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './plan-billing-cycle.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_PLANBILLINGCYCLE_LIST actions', async () => {
    ...
    it('dispatches FETCH_PLANBILLINGCYCLE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_PLANBILLINGCYCLE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_PLANBILLINGCYCLE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_PLANBILLINGCYCLE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_PLANBILLINGCYCLE actions', async () => {
      const expectedActions = [
        {
