...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './policy.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_POLICY_LIST actions', async () => {
    ...
    it('dispatches FETCH_POLICY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_POLICY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_POLICY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_POLICY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_POLICY actions', async () => {
      const expectedActions = [
        {
