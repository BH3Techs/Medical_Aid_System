...
export const AddressDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="medicalAidSystemApp.address.delete.question">
        <Translate contentKey="medicalAidSystemApp.address.delete.question" interpolate={{ id: addressEntity.id }}>
