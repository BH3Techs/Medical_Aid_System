...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_PLANCATEGORY_LIST actions', async () => {
    ...
    it('dispatches FETCH_PLANCATEGORY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_PLANCATEGORY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_PLANCATEGORY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_PLANCATEGORY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_PLANCATEGORY actions', async () => {
      const expectedActions = [
        {
