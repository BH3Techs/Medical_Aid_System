...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_BENEFITLIMIT_LIST actions', async () => {
    ...
    it('dispatches FETCH_BENEFITLIMIT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_BENEFITLIMIT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_BENEFITLIMIT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_BENEFITLIMIT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_BENEFITLIMIT actions', async () => {
      const expectedActions = [
        {
