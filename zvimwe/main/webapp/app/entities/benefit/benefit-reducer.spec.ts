...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './benefit.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_BENEFIT_LIST actions', async () => {
    ...
    it('dispatches FETCH_BENEFIT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_BENEFIT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_BENEFIT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_BENEFIT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_BENEFIT actions', async () => {
      const expectedActions = [
        {
