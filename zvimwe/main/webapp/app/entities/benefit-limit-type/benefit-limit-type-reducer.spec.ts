...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './benefit-limit-type.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_BENEFITLIMITTYPE_LIST actions', async () => {
    ...
    it('dispatches FETCH_BENEFITLIMITTYPE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_BENEFITLIMITTYPE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_BENEFITLIMITTYPE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_BENEFITLIMITTYPE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_BENEFITLIMITTYPE actions', async () => {
      const expectedActions = [
        {
