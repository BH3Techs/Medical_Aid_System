...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_BENEFITTYPE_LIST actions', async () => {
    ...
    it('dispatches FETCH_BENEFITTYPE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_BENEFITTYPE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_BENEFITTYPE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_BENEFITTYPE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_BENEFITTYPE actions', async () => {
      const expectedActions = [
        {
