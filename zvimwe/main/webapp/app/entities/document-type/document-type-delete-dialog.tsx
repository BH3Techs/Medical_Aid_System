...
export const DocumentTypeDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="medicalAidSystemApp.documentType.delete.question">
        <Translate contentKey="medicalAidSystemApp.documentType.delete.question" interpolate={{ id: documentTypeEntity.id }}>
