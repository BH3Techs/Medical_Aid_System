  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="medicalAidSystemApp.documentType.home.createOrEditLabel" data-cy="DocumentTypeCreateUpdateHeading">
            <Translate contentKey="medicalAidSystemApp.documentType.home.createOrEditLabel">Create or edit a DocumentType</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('medicalAidSystemApp.documentType.name')}
              ...
              />
              <ValidatedField
                label={translate('medicalAidSystemApp.documentType.description')}
