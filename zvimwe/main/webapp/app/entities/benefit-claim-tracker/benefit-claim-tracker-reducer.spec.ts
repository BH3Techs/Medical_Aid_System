...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './benefit-claim-tracker.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_BENEFITCLAIMTRACKER_LIST actions', async () => {
    ...
    it('dispatches FETCH_BENEFITCLAIMTRACKER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_BENEFITCLAIMTRACKER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_BENEFITCLAIMTRACKER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_BENEFITCLAIMTRACKER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_BENEFITCLAIMTRACKER actions', async () => {
      const expectedActions = [
        {
